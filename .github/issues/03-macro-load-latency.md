---
title: Loading the macro list takes 20 s or more [firmware]
labels: bug, performance, firmware
---

> **Provenance:** this analysis was written on the branch `perf/macro-list-latency` as
> `docs/investigations/03-macro-load-latency.md`. It is reproduced here verbatim so the finding is durable; the fix
